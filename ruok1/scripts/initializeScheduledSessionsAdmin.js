...
const initializeScheduledSessions = async () => {
  try {
    ...
    await db.collection('scheduledSessions').doc('initialization').set(dummyDoc);
    console.log('Successfully initialized scheduledSessions collection');

    // Delete the dummy document
    await db.collection('scheduledSessions').doc('initialization').delete();
